...
urlpatterns = [
    ...
    path('add_certification/<int:id>/',views.add_certification,name='add_certification'),
    path('show_course',views.show_course,name='show_course'),
    path('add_coursetype', views.add_coursetype, name='add_coursetype'),  # For creating
    path('add_coursetype/<int:id>/', views.add_coursetype, name='add_coursetype'), 
    ...
    path('show_duration',views.show_duration, name='show_duration'),
    ...
    path('apply/',views.apply,name='apply'),
    # path('get_applied_courses_ids/<int:id>',views.get_applied_courses_ids,name='get_applied_courses_ids'),
